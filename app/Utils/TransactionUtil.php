...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        $output['city'] = $location_details->city;
        $output['state'] = $location_details->state;
        $output['zip_code'] = $location_details->zip_code;
        $output['country'] = $location_details->country;
        $output['landmark'] = $location_details->landmark;
        ...
        if (in_array($transaction_type, ['sell', 'sales_order'])) {
            ...
            $output['subtotal_exc_tax'] = $this->num_f($subtotal_exc_tax, false, $business_details);
